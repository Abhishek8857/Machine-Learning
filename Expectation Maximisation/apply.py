...
from parameters import EM_parameters
...
epsilon, K, n_iter, skin_n_iter, skin_epsilon, skin_K, theta = EM_parameters()
...
# load datasets
data = [[], [], []]
data[0] = np.loadtxt('Exc 01\q6_expectation_maximization_python\data\data1')
data[1] = np.loadtxt('Exc 01\q6_expectation_maximization_python\data\data2')
data[2] = np.loadtxt('Exc 01\q6_expectation_maximization_python\data\data3')
...
for idx in range(3):
    ll = getLogLikelihood(means, covariances, weights  , data[idx])
...
# load gamma values
testgamma = [[], [], []]
testgamma[0] = np.loadtxt('Exc 01\q6_expectation_maximization_python\data\gamma1')
testgamma[1] = np.loadtxt('Exc 01\q6_expectation_maximization_python\data\gamma2')
testgamma[2] = np.loadtxt('Exc 01\q6_expectation_maximization_python\data\gamma3')
for idx in range(3):
...
for k in range(num):
    ...
    logLikelihood[k] = getLogLikelihood(means, covariances, weights, data[2])
...
sdata = np.loadtxt('Exc 01\q6_expectation_maximization_python/data/skin.dat')
ndata = np.loadtxt('Exc 01\q6_expectation_maximization_python/data/non-skin.dat')

img = im2double(iio.imread('Exc 01\q6_expectation_maximization_python/images/faces.png'))
